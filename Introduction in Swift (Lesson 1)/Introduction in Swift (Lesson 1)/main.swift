//
//  main.swift
//  Introduction in Swift (Lesson 1)
//
...
This is the homework programm for the first lesson of the course. Please, choose the index of one of the following sub program:
    1. Quadratic equation
    2. Right triangle parameters
    3. Bank deposit
    ...
    if let input = rawInput {
        if input == "exit" {
            ...
            switch Int(input) {
                ...
                case 2:
                    printRightTriangleParameters()
                case 3:
                    calculateBankAccountProfit()
                default:
