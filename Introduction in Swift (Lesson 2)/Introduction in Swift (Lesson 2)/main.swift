...
let homework: Array<(String, () -> Void)> = [
...
homeworkPresentation(message: "This is the homework programm for the second lesson of the course. Please, choose the index of one of the following sub program:", homework: homework)
